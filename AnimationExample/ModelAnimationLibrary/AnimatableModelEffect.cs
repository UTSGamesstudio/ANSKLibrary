...
{
    /*public class AnimatableModelEffect : SkinnedEffect, IEffectMatrices, IEffectLights, IEffectFog
    {
        public const int MAX_BONES = 72;
        ...
        public AnimatableModelEffect(SkinnedEffect effect) : base(effect) { }
