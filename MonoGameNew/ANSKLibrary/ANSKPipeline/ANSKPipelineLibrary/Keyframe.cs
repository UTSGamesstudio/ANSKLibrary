...
namespace ANSKPipelineLibrary
{
    ...
    public class Keyframe
    {
        ...
        {
            file.WriteElementString("Bone", Bone.ToString());
            file.WriteElementString("Time", Time.Ticks.ToString());
            file.WriteElementString("Transform", XmlExporter.MatrixToEntity(Transform));
        }
